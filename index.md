...
venue: "CSUF"        # brief name of host site without address (e.g., "Euphoric State University")
address: "PLS-420"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
humandate: "Some Day in the Future"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "Some Time"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: FIXME      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: FIXME        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["David P", "Rachel", "Tom C", and "Charlotte Jones-Todd"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Some Great Person"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
